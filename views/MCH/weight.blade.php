                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content table-responsive">
                                ...
                                <form action="{{route('weight_post')}}" method="post" enctype="multipart/form-data">{!! csrf_field() !!}
                                    <table class="table table-bordered">
                                        ...
                                        <table class="table-responsive">
                                            ...
                                            <tr>
                                                <td><input type="month"  name="month"  class="form-control" id="" aria-describedby="" placeholder=""></td>
