...
@section('footer')
    ...
    backgroundColor: ["#3e95cd", "#8e5ea2","#3cba9f","#e8c3b9","#c45850", "#CD329E","#E8C9D0","#B3BDC4","#00E2FF", "#2948CD","#FFC774","#95CD30"],
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> CHILD HEALTH CARD </a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <p class="category">Height increase chart</p>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons"></i>
