...
@section('footer')
        ...
        new Chart(document.getElementById("bar-chart-horizontal"), {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: "weight",
                        backgroundColor: ["#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb","#fffffb"],
    ...
    <script>
        new Chart(document.getElementById("line-chart"), {
            type: 'line',
            data: {
                labels: [@if(isset($motherstemperature_results))
                    @foreach($motherstemperature_results as $motherstemperature_result)
                    {{$motherstemperature_result->month}},
                    @endforeach
                    @endif],
                datasets: [{
                    data: [@if(isset($motherstemperature_results))
                        @foreach($motherstemperature_results as $motherstemperature_resultss)
                        {{$motherstemperature_resultss->temp}},
                        @endforeach
                        @endif],
                    label: "temp",
                    borderColor: "#fffffb",
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> MATERNAL PROFILE </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <p class="category">
                                        <span class="text-success"><i class="fa fa-long-arrow-up"></i> 15% </span> increase in temperature submissions.</p>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <p class="category">blood pressure chart</p>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons"></i>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="title">weight chart</h4>
