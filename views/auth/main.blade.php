...
<html>
	...
	<body>
			...
			<header id="header">
				...
				<nav>
					<ul>
						...
						<li><a style="color: white;" href="{{route('login')}}">Patients </a></li>
		...
		<!-- Footer -->
			<footer id="footer">
				<p style="color: white;" class="copyright"> Copyright &copy; Tilt Systems <a style="color: white;" href="https://tilt.net">Tilt Systems</a>.</p>
			</footer>
		</div>
